...
bool RefCountedThreadSafeBase::HasOneRef() const { return ref_count_.IsOne(); }
...
bool RefCountedThreadSafeBase::Release() const { return ReleaseImpl(); }
void RefCountedThreadSafeBase::AddRef() const { AddRefImpl(); }
